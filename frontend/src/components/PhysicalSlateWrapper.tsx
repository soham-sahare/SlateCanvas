      ...
      <div className="relative w-full h-full shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col transition-all duration-300 ring-1 ring-black/5">
        ...
        */}
        <div className="absolute inset-[12px] md:inset-[18px] lg:inset-[24px] rounded-[8px] bg-[#2A313C] dark:bg-[#1e232b] shadow-[inset_0_4px_15px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col">
          ...
          {/* Footer */}
          {showFooter && (
            <footer className="relative z-40 w-full px-8 py-6 flex items-center justify-between text-[11px] uppercase tracking-widest text-[#cbd5e1]/40 mt-auto font-medium">
              <div className="flex items-center gap-1.5 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all cursor-default">
                ...
                <span>by</span>
                <Link href="https://sohamsahare.in/" target="_blank" rel="noopener noreferrer" className="text-[#e2e8f0] hover:text-[#4dd0e1] transition-colors">
                  sohamsahare
                </Link>
              </div>

              <Link href="https://github.com/soham-sahare/SlateCanvas" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all" aria-label="GitHub Repository">
