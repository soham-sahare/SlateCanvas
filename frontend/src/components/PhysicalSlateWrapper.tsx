      ...
      <div className="relative w-full h-full shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col transition-all duration-300 ring-1 ring-black/5">
        ...
        */}
        <div className="absolute inset-[12px] md:inset-[18px] lg:inset-[24px] rounded-[8px] bg-[#2A313C] dark:bg-[#1e232b] shadow-[inset_0_4px_15px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col">
          ...
          {/* Faux Chalk Elements */}
          {mounted && (
            <div className="absolute bottom-24 w-full max-w-5xl mx-auto px-8 flex justify-between items-end opacity-40 pointer-events-none z-0">
              {/* Left Squiggly line */}
              ...
              {/* Center Scribbles added per user request */}
              <svg className="w-40 h-20 text-[#e2e8f0] opacity-30 absolute left-1/2 -translate-x-1/2 bottom-[-10px]" viewBox="0 0 200 100" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M 20 50 Q 50 10 80 50 T 140 50 T 180 50" />
                <path d="M 30 60 Q 60 20 90 60 T 150 60 T 190 60" />
                <path d="M 40 70 Q 70 30 100 70 T 160 70" />
              </svg>
          ...
          {/* Footer */}
          {showFooter && (
            <footer className="relative z-40 w-full px-6 py-6 flex items-center justify-between text-sm text-[#cbd5e1]/80 border-t border-white/5 mt-auto">
