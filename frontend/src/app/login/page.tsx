        ...
        <div className="relative w-full max-w-md p-8 sm:p-10 rounded-2xl shadow-xl dark:shadow-2xl bg-white dark:bg-[#1e232b] border border-slate-200 dark:border-white/5 transition-all overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-[#f8fafc]">Welcome back</h1>
              <p className="text-sm text-slate-600 dark:text-[#cbd5e1]/80">Log in to your SlateCanvas account.</p>
            </div>
